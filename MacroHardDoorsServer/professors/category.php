...
<div id="k2Container" class="genericView professorsListView <?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
		...
		<?php if(isset($this->category) || ( $this->params->get('subCategories') && isset($this->subCategories) && count($this->subCategories) )): ?>
				...
				<div class="itemsCategory">
						...
						<h1>
							...
							<?php if($this->params->get('catTitleItemCounter')) echo ' <small>('.$this->pagination->total.')</small>'; ?>
						</h1>
						<?php endif; ?>
		...
		<div class="itemList">
				<?php if(isset($this->leading) && count($this->leading)): ?>
						...
						if($this->params->get('num_leading_columns') > 1) {
							echo '<div class="itemsContainerWrap" style="width: '.(100 / $this->params->get('num_leading_columns')).'%">';
						}
				...
				<?php if(isset($this->primary) && count($this->primary)): ?>
						...
						if($this->params->get('num_primary_columns') > 1) {
							echo '<div class="itemsContainerWrap" style="width: '.(100 / $this->params->get('num_primary_columns')).'%">';
						}
				...
				<?php if(isset($this->secondary) && count($this->secondary)): ?>
						...
						if($this->params->get('num_secondary_columns') > 1) {
							echo '<div class="itemsContainerWrap" style="width: '.(100 / $this->params->get('num_secondary_columns')).'%">';
						}
